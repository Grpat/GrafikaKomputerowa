...
//    public static void uvPiramid(GL2 gl)
//    {
...
//        for (int i = 0; i <= 18; i++)
//        {
//            gl.glTexCoord2d(1.0/18 * i, 0);
//            gl.glVertex3d((100*Math.cos(i * 2 * Math.PI / 18))/250, -0.4, (100 * Math.sin(i * 2 * Math.PI / 18))/250);
//        }
//
//        gl.glEnd();
//    }
