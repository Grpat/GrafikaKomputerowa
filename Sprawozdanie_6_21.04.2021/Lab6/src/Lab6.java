...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		float [] emerald= { 0.0215f, 0.1745f, 0.0215f, 1.0f, 0.07568f, 0.61424f, 0.07568f, 1.0f, 0.633f, 0.727811f, 0.633f, 1.0f, 0.6f*128};
...
//		gl2.glLightModelfv( GL2.GL_LIGHT_MODEL_AMBIENT, ambientLevel, 0 );
		...
		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_DIFFUSE, emerald,4);
		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_SPECULAR, emerald,8);
		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_AMBIENT, emerald,0);



		gl2.glBegin(gl2.GL_TRIANGLE_FAN);
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, emerald, 0);
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, emerald, 4 );
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, emerald, 8);
		gl2.glMaterialf( GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS,emerald[12] );

		//wierzchołek:
		gl2.glVertex3f(0.0f,5.0f,0.0f);
		// punkty wielokąta:
		gl2.glVertex3f(3.0f , -1.5f, 0.0f);
		gl2.glVertex3f(2.82f , -1.5f, 1.025f);
		gl2.glVertex3f(2.3f , -1.5f, 1.93f);
		gl2.glVertex3f(1.5f , -1.5f, 2.6f);
		gl2.glVertex3f(0.52f , -1.5f, 2.955f);
		gl2.glVertex3f(-0.52f , -1.5f, 2.955f);
		gl2.glVertex3f(-1.5f , -1.5f, 2.6f);
		gl2.glVertex3f(-2.3f , -1.5f, 1.93f);
		gl2.glVertex3f(-2.82f , -1.5f, 1.025f);
