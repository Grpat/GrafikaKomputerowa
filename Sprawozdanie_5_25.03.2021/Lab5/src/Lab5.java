	...
	private void draw(GL2 gl2) {
        ...
        switch(objectNumber)
        {
            case 1:
                ...
                r=0.05f;
                z=0.00f;
                radians = (float) (Math.PI/180.0);
                gl2.glBegin(gl2.GL_LINE_STRIP);
                for(i = 0.0f;i <6500.0f;i+=1.0)
                {
                    gl2.glVertex3f((float)(r*Math.cos(i*radians)),(float)( r*Math.sin(i*radians)), z);
                    z+=0.001;
                    r+=0.0003;
                }
                gl2.glEnd();
            ...
            case 2:
                ...
                gl2.glColor3f(0, 1, 0);
                //wierzchołek:
                gl2.glVertex3f(0.0f,0.0f,3.0f);
                // punkty wielokąta:
                gl2.glVertex3f(3.0f , 0.0f, -5.0f);
                gl2.glVertex3f(2.82f , 1.025f, -5.0f);
                gl2.glVertex3f(2.3f , 1.93f, -5.0f);
                gl2.glVertex3f(1.5f , 2.6f, -5.0f);
                gl2.glVertex3f(0.52f , 2.955f, -5.0f);
                gl2.glVertex3f(-0.52f , 2.955f, -5.0f);
                gl2.glVertex3f(-1.5f , 2.6f, -5.0f);
                gl2.glVertex3f(-2.3f , 1.93f, -5.0f);
                gl2.glVertex3f(-2.82f , 1.025f, -5.0f);
