...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		g2.translate(1.7,-0.75);
		rotatingPolygon(g2);


		g2.setTransform(oldForm);

		g2.translate(0.35,-0.40);
		...
		g2.translate(-2.4,0.0);
		g2.scale(0.525,1.875);
